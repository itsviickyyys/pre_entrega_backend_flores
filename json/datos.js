 ...
 const productos = [
    ...
    {productId: "RB2", nombre: "Rubor", description:"Rubor tono rosa intenso marca DIOR", price: 20000, stock: 20, status:true},
    {productId: "AM3", nombre: "Agua Micelar", description:"Agua micelar marca NIVEA BIFASICA", price: 6000, stock:60, status:true},
    {productId: "TD4", nombre: "Toallitas desmaquillantes", description:"Toallitas Humedas Marca Farmacity", price: 6000, stock: 80, status:true},
    {productId: "AG5", nombre: "Algodón", description:"Algodón Marca Farmacity", price: 4000,  stock: 100, status:true},
    {productId: "KDC6", nombre: "Kit de cosmeticos", description:"Kit de cosmeticos color azul", price: 4000, stock: 16, status:true},
    {productId: "CH7", nombre: "Crema Hidratante", description:"Crema Hidratante marca DOVE", price: 4000, stock: 80, status:true},
];
